package com.ziojio.hummer.adapter;
...
import com.ziojio.hummer.ui.HummerActivity;

public class ZuiAppIntentCreator implements IntentCreator {
    ...
    public Intent createHummerIntent(Context context, NavPage page) {
        ...
        intent.setClassName(context, HummerActivity.class.getName());
