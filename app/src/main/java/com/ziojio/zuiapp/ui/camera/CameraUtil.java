package com.ziojio.zuiapp.ui.camera;
...
public class CameraUtil {
    ...
    public static boolean isBack(CameraManager cameraManager, CameraDevice cameraDevice) {
        ...
        try {
            CameraCharacteristics c = cameraManager.getCameraCharacteristics(cameraDevice.getId());
            facingBack = c.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_BACK;
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
        return facingBack;
    ...
    public static boolean isBack(CameraCharacteristics c) {
        return c.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_BACK;
    }
